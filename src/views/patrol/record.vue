<template>
  <div class="app-container">
    <el-input v-model="value" placeholder="巡检线路" style="width:300px;" prefix-icon="el-icon-document" />
    <el-input v-model="filename" placeholder="巡检员" style="width:300px;" prefix-icon="el-icon-document" />
