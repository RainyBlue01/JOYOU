<template>
  <div class="app-container">
    <el-select v-model="value" placeholder="请选择人员类型" v-if="!li" >
      <el-option
    ...
    <el-input v-model="filename" placeholder="人员名字" style="width:300px;" prefix-icon="el-icon-document" />
    <el-button :loading="downloadLoading" style="margin-bottom:20px;" type="primary" icon="document" @click="handleDownload">
      搜索
    </el-button>
     <el-input v-model="filename" placeholder="设备编码" style="width:300px;" prefix-icon="el-icon-document" />
    <el-button :loading="downloadLoading" style="margin-bottom:20px;" type="primary" icon="document" @click="handleDownload">
      搜索
    </el-button>
